...
public class Array2dUtility {
    ...
    public static double average(int[][] array) {
        ...
        int totalElements = array.length * array.length; // Since the array is square
    ...
    // 10. colSums
    // Implement a method called colSums that returns a one-dimensional array that contains the sum of each column at each index.
